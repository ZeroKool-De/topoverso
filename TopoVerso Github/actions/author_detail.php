...
$sql_collaborators = "
    SELECT p2.person_id, p2.name, p2.slug, COUNT(sp1.story_id) as collaboration_count
...
$sql_top_chars = "
    SELECT c.character_id, c.name, c.slug, c.character_image, COUNT(sc.story_id) AS appearance_count
                ...
                <ul>
                    <?php foreach ($frequent_collaborators as $collaborator): ?>
                        <li>
                            ...
                            <small>(<?php echo $collaborator['collaboration_count']; ?> storie)</small>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
                ...
                <ul>
                    <?php foreach ($top_characters_by_author as $character): ?>
                        <li>
                            ...
                            <small>(<?php echo $character['appearance_count']; ?> storie)</small>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </div>
                        ...
                        <li>
                            <a href="#<?php echo $role_id; ?>" 
                               ...
                               data-tab-target="<?php echo $role_id; ?>">
                                <?php echo htmlspecialchars(ucfirst($role_name)); ?> (<?php echo count($contributions_list); ?>)
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
